...
int Serveur::processAuthenticationManagement(int index)
{
    ...
    while (!(messageQueue.empty()))
    {
        ...
        {
            addHistoryChat(create_message(*client, ":SERVER", "Error : echec commande introuvable ou authentification non faite\n"));
...
int Serveur::processCommandManagement(int index)
{
    ...
    while (!(messageQueue.empty()))
    {
        ...
        {
            addHistoryChat(create_message(*client, ":SERVER", "Error : echec commande introuvable\n"));
